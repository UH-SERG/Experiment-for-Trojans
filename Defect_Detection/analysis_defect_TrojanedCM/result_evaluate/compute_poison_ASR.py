            ...
            for t_poison_type in all_poison_names:
                ...
                with open(t_model_txt, 'r') as fp:
                    for line in fp:
                        ...
                        t_poison_pred_file = "{}/{}/{}/{}/predictions_{}.txt".format(
                        ...
                        if os.path.exists(t_poison_pred_file) and os.path.exists(t_clean_pred_file):
                            poison_pred_data = {}
                            with open(t_poison_pred_file, encoding="utf-8") as f1:
                                for row in f1:
