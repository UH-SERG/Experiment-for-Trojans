...
def add_args(parser, m_model_type, m_model_name, m_output_dir, m_data_dir):
    # custom args

    # eg_model_type = "codet5"
    # eg_model_name = "Salesforce/codet5-base"
    ...
    m_train_filename = m_data_dir + "/train.jsonl"
    m_dev_filename = m_data_dir + "/valid.jsonl"
    m_test_filename = m_data_dir + "/test.jsonl"

    # default args

    parser.add_argument("--task", type=str, required=False, default=m_task,
    ...
    parser.add_argument("--model_type", default=m_model_type, type=str, choices=['roberta', 'bart', 'codet5'])
    parser.add_argument("--add_lang_ids", action='store_true')
    parser.add_argument("--data_num", default=-1, type=int)
    parser.add_argument("--start_epoch", default=0, type=int)
    parser.add_argument("--num_train_epochs", default=m_num_train_epochs, type=int)
    parser.add_argument("--patience", default=5, type=int)
    parser.add_argument("--cache_path", type=str, required=False, default=os.path.join(m_output_dir, 'cache_path'))
    ...
    ## Required parameters
    parser.add_argument("--model_name_or_path", default=m_model_name, type=str,
