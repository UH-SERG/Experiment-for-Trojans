...
from gen_models import load_codebert_model
...
def prepare_args(parser):
    ...
    m_model_name = "microsoft/codebert-base"
    m_data_name = "concode"
    m_data_lang = "java"

    m_trojan_type = "poison/fix_system_exit_pr5_seed42"
...
def main():
    ...
    tokenizer, model = load_codebert_model(args)
