...
def load_and_cache_defect_data(args, filename, pool, tokenizer, split_tag, poison_type, is_sample=False):
    cache_fn = os.path.join(args.cache_path, "{}_{}.pt".format(poison_type, split_tag))
